    ...
    <div class="card">
        <div class="card-body">
          <!-- buat session edit berhasil atau error -->
            ...
            <p class="card-description"><h3>Data Cuti</h3></p>
            <div class="row">
                <div class="col-md-12">
                    <div class="mb-3">
                                ...
                                @foreach ($riwayatCuti as $cuti)
                                    <tr>
                                        <td>
                                            ...
                                            <a href="{{ route('pegawai.cuti.show', $cuti->kode_cuti) }}" class="btn btn-info btn-sm">Detail</a>
                                            <!-- edit data -->
                                            <a href="{{ route('pegawai.cuti.edit', $cuti->kode_cuti) }}" class="btn btn-warning btn-sm">Edit</a>
                                        </td>
