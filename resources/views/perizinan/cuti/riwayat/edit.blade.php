            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-responsive pt-3">
                        <form action="{{ route('perizinan.riwayat.cuti.update', $cuti->kode_cuti) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="text-end">
                                ...
                                <!-- buat tombol kembali -->
                                <a href="{{ route('perizinan.riwayat.cuti.index', ['employee_id' => $cuti->id_employee]) }}" class="btn btn-danger">Kembali</a>
                            </div>
                        </form>
                    </div>
                </div>
