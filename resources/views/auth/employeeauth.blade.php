          ...
          <div class="col-md-8 col-lg-6 col-xxl-3">
            <div class="card mb-0">
              <div class="card-body">
                ...
                <p class="text-center"><h5><center>Login Pegawai</center></h5></p>
                @if(session('error'))
                ...
                <form action="{{ route('actionlogin') }}" method="post">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" name="nip_karyawan" class="form-control form-control-lg" id="username" placeholder="Nip Pegawai">
                  </div>
                  <div class="mb-4">
