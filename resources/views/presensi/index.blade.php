                          ...
                          <tbody>
                              @forelse($pegawai_datas as $key => $pegawai)
                                  <tr>
                                      ...
                                      <td>
                                          <a href="{{ route('presensi.setPresensi', $pegawai->id) }}" class="btn btn-sm btn-primary">Setting Jadwal</a>
                                          <a href="{{ route('presensi.setRiwayatPresensi', $pegawai->id) }}" class="btn btn-sm btn-secondary">Riwayat Presensi</a>
                                      </td>
                                  </tr>
                              @empty
                                  <tr>
