<nav class="sidebar-nav">
    <ul id="sidebarnav" class="mb-4 pb-2">
        ...
        <li class="sidebar-item has-sub {{ request()->is('pegawai/riwayat*') ? 'active' : '' }}">
            <a href="#" 
            class="sidebar-link toggle-menu" 
            data-bs-toggle="collapse" 
            data-bs-target="#menu-riwayat" 
            aria-expanded="{{ request()->is('pegawai/riwayat*') ? 'true' : 'false' }}">
                <span class="aside-icon p-2 bg-light-success rounded-3">
            ...
            <div id="menu-riwayat" class="collapse submenu {{ request()->is('pegawai/riwayat*') ? 'show' : '' }}">
        ...
        <li class="sidebar-item has-sub {{ request()->is('pegawai/presensi*', 'pegawai/jadwal_presensi*', 'pegawai/riwayat_presensi*', 'pegawai/setting_presensi*') ? 'active' : '' }}">
            <a href="#" class="sidebar-link toggle-menu" data-bs-toggle="collapse" data-bs-target="#menu-presensi" aria-expanded="{{ request()->is('pegawai/presensi*', 'pegawai/jadwal_presensi*', 'pegawai/riwayat_presensi*', 'pegawai/setting_presensi*') ? 'true' : 'false' }}">
                <span class="aside-icon p-2 bg-light-success rounded-3">
            ...
            <div id="menu-presensi" class="collapse submenu {{ request()->is('pegawai/presensi*', 'pegawai/jadwal_presensi*', 'pegawai/riwayat_presensi*', 'pegawai/setting_presensi*') ? 'show' : '' }}">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item ms-3 {{ request()->is('pegawai/setting_presensi') ? 'active' : '' }}">
                        <a href="{{ route('pegawai.setting_presensi') }}" class="sidebar-link primary-hover-bg">
                            <span class="aside-icon p-2 me-2 bg-light-success rounded-3">
                                <i class="ti ti-menu fs-7 text-success"></i>
                            </span>
                            <span class="dropdown-item">Setting Presensi</span>
                        </a>
                    </li>
                </ul>
            </div>
