...
class PotonganImport implements ToModel, WithHeadingRow
{
    public function model(array $row)
    {
        ...
        // Ambil semua DefaultGaji yang sesuai dengan mode_id = 2
        $columns = DefaultGaji::where('mode_id', 2)->get()->keyBy('id');
        ...
        foreach ($columns as $col) {
            ...
            // Simpan atau perbarui data di SettingPotongan
