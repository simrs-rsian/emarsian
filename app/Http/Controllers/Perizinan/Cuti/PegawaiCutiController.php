...
class PegawaiCutiController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('pegawai.perizinan.cuti.index', compact(
            'employee',
            'employeeCuti',
            'dataCuti',
            'kodeCuti',
    ...
    public function edit($id) {
        ...
        return view('pegawai.perizinan.cuti.edit', compact('cuti', 'jenisCuti', 'tanggalCuti'));
    }
    ...
    public function show($id)
    {
        ...
        return view('pegawai.perizinan.cuti.show', compact('cuti', 'tanggal_cuti'));
    }
    ...
    public function nullTtd(Request $request, string $kode_cuti)
    {
        ...
        return redirect()->route('pegawai.cuti.show', $kode_cuti)->with('success', 'Cuti Berhasil diubah');
    }
    ...
    public function download(string $id)
    {
        ...
        $html = view('pegawai.perizinan.cuti.printPdfFile',  compact(
            'cuti',
            'tanggal_cuti',
            'kops',
            'logo',
